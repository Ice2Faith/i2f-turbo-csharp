<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="StudentInfoModify.aspx.cs" Inherits="UniversityGraduate.Pages.StudentInfoModify" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentBody" runat="server">
    <div style="border: 1px solid #808080; height: 600px; background: linear-gradient(to bottom,#f5feff,#c5e3e9);">
        <div style="text-align: center; font-size: 36px; color: #0094ff; font-weight: bolder;">
            开始填写您的专属信息吧！
        </div>

        <div style="width: 720px; margin: 150px auto;">
            <table>
                <tr>
                    <td>姓名：</td>
                    <td>
