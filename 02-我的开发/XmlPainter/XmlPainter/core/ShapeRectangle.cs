...
{
    public class ShapeRectangle : PainterShape
    {
        public double width;
        ...
        public override void draw(Graphics gra)
        {
            ...
            gra.FillRectangle(br, (float)posX, (float)posY, (float)width, (float)height);

            Pen pen = new Pen(Color.Blue);
            gra.DrawRectangle(pen, (float)posX, (float)posY, (float)width, (float)height);
